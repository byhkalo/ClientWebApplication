...
Goal:
     Verify the basket managing from product list controller

Process description:
     Create integration test for modeling case with Adding, Removing products from basket. 
...
import { MatSidenavModule, MatToolbarModule, MatFormFieldModule, MatSelectModule, MatGridListModule, MatPaginatorModule, MatInputModule, MatSortModule, MatButtonModule, MatListModule, MatExpansionPanelActionRow, MatBadgeModule, MatCardModule, MatDialogModule } from '@angular/material';
...
describe('Integration Test 3 - Verify the basket managing from product list controller', () => {
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            ...
            declarations: [ ProductComponent, MockFiltersComponent, AppComponent, MainShopComponentComponent, ProductsComponent]
        })
        .compileComponents();
    }));
    ...
    it('Add first product to the empty basket', () => {
        ...
        expect(componentProduct.isCanAdd).toEqual(true);
        let event = new Event('click');
        componentProduct.addOneProduct(event);

        expect(componentProduct.product.count).toEqual(19);
    ...
    it('Remove one product from basket with one product', () => {
        ...
        componentProduct.removeOneProduct(event);
    ...
    it('Add product multiple times', () => {
        ...
        expect(componentProduct.product.count).toEqual(15);
    ...
    it('Remove one product type from basket', () => {
        ...
        expect(componentProduct.product.count).toEqual(16);
